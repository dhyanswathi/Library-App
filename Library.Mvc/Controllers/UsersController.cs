...
namespace Library.Mvc.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Name,Email,Age")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Name,Email,Age")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
